...
namespace Drugstore.DataSetItemsTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Items] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([category] = @Original_category) AND ([count] = @Original_count) AND ([price] = @Original_price) AND ([discont] = @Original_discont) AND ([position] = @Original_position))";
...
SELECT id, name, category, text, count, price, discont, image, position FROM Items WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [name] = @name, [category] = @category, [text] = @text, [count] = @count, [price] = @price, [discont] = @discont, [image] = @image, [position] = @position WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([category] = @Original_category) AND ([count] = @Original_count) AND ([price] = @Original_price) AND ([discont] = @Original_discont) AND ([position] = @Original_position));
SELECT id, name, category, text, count, price, discont, image, position FROM Items WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        id, name, category, text, count, price, discont, image, position\r\nF" +
                "ROM            Items\r\nWHERE        (count > 0)";
        ...
        public virtual int Fill(DataSetItems.ItemsDataTable dataTable) {
        ...
        public virtual DataSetItems.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetItems.ItemsDataTable dataTable = new DataSetItems.ItemsDataTable();
        ...
        public virtual int SelectPl(DataSetItems.ItemsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetItems.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_category, int Original_count, double Original_price, double Original_discont, string Original_position) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((double)(Original_discont));
        ...
        public virtual int Insert(string name, string category, string text, int count, double price, double discont, byte[] image, string position) {
            if ((name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((double)(discont));
            if ((image == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((double)(discont));
            if ((image == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((double)(Original_discont));
            if ((Original_position == null)) {
                throw new global::System.ArgumentNullException("Original_position");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string category, string text, int count, double price, double discont, byte[] image, string position, int Original_id, string Original_name, string Original_category, int Original_count, double Original_price, double Original_discont, string Original_position) {
